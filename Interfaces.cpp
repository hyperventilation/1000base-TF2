...
void Interfaces::InitInterfaces()
{
	...
	I::Engine = (IVEngineClient *)g_Interfaces->brute_iface("EngineClient", "VEngineClient", "g_pEngine", "engine.dll");
	...
	DWORD* dwCHLClientTable = (DWORD*)*(DWORD*)I::Client;
	I::ClientMode = **(IClientModeShared***)((DWORD)dwCHLClientTable[10] + 0x05);
